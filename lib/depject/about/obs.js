...
module.exports = function (api) {
  ...
  return {
    'about.obs.name': (id) => socialValue(id, 'name', shortFeedId(id)),
    'about.obs.description': (id) => socialValue(id, 'description'),
    'about.obs.image': (id) => socialValue(id, 'image'),
    'about.obs.names': (id) => groupedValues(id, 'name'),
    'about.obs.images': (id) => groupedValues(id, 'image'),
    'about.obs.color': (id) => computed(id, (id) => colorHash.hex(id)),

    'about.obs.imageUrl': (id) => computed(socialValue(id, 'image'), (blobId) => {
      return blobId ? api.blob.sync.url(blobId) : fallbackImageUrl
    }),

    'about.obs.valueFrom': valueFrom,
    'about.obs.latestValue': latestValue,
    'about.obs.socialValue': socialValue,
    'about.obs.socialValues': socialValues,
    'about.obs.groupedValues': groupedValues
  }
