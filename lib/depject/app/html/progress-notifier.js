...
module.exports = function (api) {
  ...
  return {
    'app.html.progressNotifier': function () {
      ...
      const readOnlyMode = `
        ...
        button:not(.-clear):not(.-cancel):not(.cancel), .like, .reply, .ToggleButton, .Picker {
          cursor: wait;
          opacity: 0.5;
        }

        button:not(.-clear):not(.-cancel):not(.cancel):active, .like:active, .reply:active, .ToggleButton:active, .Picker:active {
          cursor: not-allowed;
        }
      `
